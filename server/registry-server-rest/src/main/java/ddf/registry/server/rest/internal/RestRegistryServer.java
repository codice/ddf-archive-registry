...
public class RestRegistryServer {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(RestRegistryServer.class);

    private ServiceRegistry serviceRegistry;

    public RestRegistryServer(ServiceRegistry serviceRegistry) {
    ...
    private JSONObject convertServiceInfo(ServiceInfo service, UriInfo uriInfo) {
        ...
        propertyMap.put(ServiceInfo.URL_KEY,
                combineUrl(uriInfo.getBaseUri(), service.getServiceRelativeUrl()));
